...
subtitle: "Organização de projetos no R/RStudio"
...
knitr::include_graphics("img/021-organizacao-de-projetos/foto_perfil.jpg")
```
]
...
```{r, echo = FALSE, out.width=400, out.height=400, fig.align="center"}
knitr::include_graphics("img/021-organizacao-de-projetos/hex_zen.png")
```
